    ...
    class FiltroM
    {
		...
		public static void floodFill(int x, int y, Color cor, Bitmap b)
		{
			...
			while(pilha.Count > 0)
			{
				...
				if (y > 0 && y < b.Height-1 && x > 0 && x < b.Width-1 && b.GetPixel(x + 1, y) != Color.FromArgb(255, 0, 0, 0))
					pilha.Push(new NoPilha(x + 1, y));
				if (y > 0 && y < b.Height-1 && x > 0 && x < b.Width-1 && b.GetPixel(x, y + 1) != Color.FromArgb(255, 0, 0, 0))
